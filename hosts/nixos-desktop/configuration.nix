{config, ...}: {
  ...
  services.usbguard.rules = ''
    ...
    <<<<<<< HEAD
    =======
        allow id 3297:1969 serial "QJqBD/m5yQWV" name "Moonlander Mark I" hash "bxM9Xc9WprpB1kvFtNR1Y/3cwrjv6vYFua3Z7ewZINE=" parent-hash "+XquLJ1PcxL46fLrSbVNwpIn3oJQYx8VHJUWeqlOsws=" with-interface { 03:01:01 03:00:00 03:00:00 } with-connect-type "hotplug"
    >>>>>>> a152656 (added steam and nixcord)
